...
public class ProductOrderPage {
    ...
    public  void sendAddressInformatin(String customerName,String street,String city,
    ...
    public void  getInfo(String productName,String quantity,String customerName,String street,String city,String state
            ,String zipcode,String cardType, String cardNumber,String expireDate){

       Assert.assertEquals( productInfo.get(1).getText().trim(),productName);
        Assert.assertEquals(productInfo.get(2).getText().trim(),quantity);
        Assert.assertEquals(productInfo.get(3).getText().trim(),customerName);
        Assert.assertEquals(productInfo.get(5).getText().trim(),street);
        Assert.assertEquals(productInfo.get(6).getText().trim(),city);
        Assert.assertEquals(productInfo.get(1).getText().trim(),state);
        Assert.assertEquals(productInfo.get(7).getText().trim(),zipcode);
        Assert.assertEquals(productInfo.get(8).getText().trim(),cardType);
        Assert.assertEquals(productInfo.get(9).getText().trim(),cardNumber);
        Assert.assertEquals(productInfo.get(10).getText().trim(),expireDate);
