...
public class BrowserUtils {
    ...
    //we create rowserutils to be able to call reusable methods from here to reduce amount of
    //the codes
    ...
    public static void scrollwithXandYCordinate(WebDriver driver, WebElement element) {
    ...
    public static void switchByTittle(WebDriver driver,String title){
    ...
    public  static void getScreenShot(WebDriver driver,String pagkageName){
        File file =((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
        String location =System.getProperty("user.dir")+"/src/java/screenshot"+pagkageName;
        try {
